      ...
      <ul class="space-y-2 font-medium">
         ...
         <li>
            <a
                :href="route('status.index')"
                :class="[
                  ($page.url === '/status' || $page.url === '/status/index') ? 'bg-purple-200 font-semibold dark:bg-purple-700' : '',
                  'flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-purple-100 dark:hover:bg-purple-700 group'
                ]"
            >
   ...
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul class="space-y-2 font-medium">
        <li>
         ...
         <!-- Add: Senarai Tindakan for Kerani -->
         <li>
            <a
                :href="route('status.index')"
                :class="[
        ...
        <li>
            <a
                ...
                :class="[
                  $page.url.startsWith('/renew-license') ? 'bg-purple-200 font-semibold dark:bg-purple-700' : '',
                  ($page.url === '/status' || $page.url === '/status/index') ? '' : '', // Prevent highlight clash
                  'flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-purple-100 dark:hover:bg-purple-700 group'
                ]"
            >

...
const OnDelete = (row) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            router.delete(route('butiranpengurus.destroy', { id: row })).then(() => {
                Swal.fire({
                    title: "Dipadamkan!",
...
watch(search, (newSearch) => {
    router.get(route('butiranpengurus.index'), { search: newSearch }, { preserveState: true });
});
const clearSearch = () => {
...
<template>
    <AppLayout title="Butiran Pengurus">
        <template #header>
                        ...
                        <tr v-for="(butiranPengurus,index) in props.butiranPengurus.data" class="border-b dark:border-gray-700">
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    <a :href="route('butiranpengurus.show', butiranPengurus.id)">

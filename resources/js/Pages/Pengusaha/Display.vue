...
const form = useForm({
  ...
  nama_pengusaha: props.Pengusaha?.nama_pengusaha,
  kad_pengenalan_pengusaha: props.Pengusaha?.kad_pengenalan_pengusaha,
  warganegara_pengusaha: props.Pengusaha?.warganegara_pengusaha,
  alamat_rumah_pengusaha: props.Pengusaha?.alamat_rumah_pengusaha,
  alamat_berlainan_pengusaha: props.Pengusaha?.alamat_berlainan_pengusaha,
  email_pengusaha: props.Pengusaha?.email_pengusaha,
  telefon_pengusaha: props.Pengusaha?.telefon_pengusaha,
  faks_pengusaha: props.Pengusaha?.faks_pengusaha,
  jenis_pengusaha:props.Pengusaha?.jenis_pengusaha,
...
<template>
    <AppLayout title="Maklumat Pengusaha">
        <template #header>
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden sm:rounded-lg shadow-lg">
                    ...
                    <div class="flex justify-between items-center px-6 py-4 bg-gray-100 border-b">
                        <h3 class="text-lg font-semibold text-gray-700">Butiran Pengusaha</h3>
                        <div class="relative">
                            <button

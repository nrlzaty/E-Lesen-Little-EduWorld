...
const OnDelete = (row) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            router.delete(route('butirantaska.destroy', { id: row })).then(() => {
                Swal.fire({
                    title: "Dipadamkan!",
...
watch(search, (newSearch) => {
    router.get(route('butirantaska.index'), { search: newSearch }, { preserveState: true });
});
const clearSearch = () => {
...
<template>
    <AppLayout title="Butiran Taman Asuhan Kanak-Kanak">
        <template #header>
...
<section class="sm:p-5 antialiased">
    <div class="mx-auto max-w-screen-xl px-4 lg:px-12">
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-4">Nama TASKA</th>
                            <th scope="col" class="px-4 py-3">Emel </th>
                            <th scope="col" class="px-4 py-3">Laman Web  </th>
                    ...
                    <tbody>
                        <tr v-for="(butiranTaska,index) in props.butiranTaska.data" class="border-b dark:border-gray-700">
                            <th v-if="butiranTaska.applicant" scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ butiranTaska.applicant.nama }}</th>
                            
                            <td class="px-4 py-3">{{ butiranTaska.nama_taska }}</td>
                            <td class="px-4 py-3">{{ butiranTaska.email_taska }}</td>
                            <td class="px-4 py-3">{{ butiranTaska.laman_web_taska }}</td>
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    <a :href="route('butirantaska.show', butiranTaska.id)">
        ...
        <div class="float-end">
             <Pagination class="mt-4" :links="butiranTaska.links"/>
        </div>

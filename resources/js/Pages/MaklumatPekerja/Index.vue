...
const OnDelete = (row) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            router.delete(route('maklumatpekerja.destroy', { id: row })).then(() => {
                Swal.fire({
                    title: "Dipadamkan!",
...
watch(search, (newSearch) => {
    router.get(route('maklumatpekerja.index'), { search: newSearch }, { preserveState: true });
});
const clearSearch = () => {
...
<template>
    <AppLayout title="Maklumat Pekerja">
        <template #header>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-4">Nama Pekerja</th>
                            <th scope="col" class="px-4 py-3">Kad Pengenalan</th>
                    ...
                    <tbody>
                        <tr v-for="(maklumatPekerja,index) in props.maklumatPekerja.data" class="border-b dark:border-gray-700">
                            <th v-if="maklumatPekerja.applicant" scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                {{ maklumatPekerja.applicant.nama }}</th>
                            
                            <td class="px-4 py-3">{{ maklumatPekerja.nama_pekerja }}</td>
                            <td class="px-4 py-3">{{ maklumatPekerja.kad_pengenalan_pekerja }}</td>
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    ...
                                    <a :href="route('maklumatPekerja.edit', maklumatPekerja.id)">

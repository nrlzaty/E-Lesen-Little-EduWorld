...
const form = useForm({
    ...
    code_name:props.role.code_name,
...
const OnSubmit = () => {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      form.put(route('setting.role.update', props.role.id), {
        errorBag: 'updateRole',
        preserveScroll: true,
      });
...
<template>
    <AppLayout title="Kemaskini Peranan">
        <template #header>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a :href="route('setting.role.index')" class="ml-1 text-sm font-medium text-gray-700 hover:text-gray-900 md:ml-2 dark:text-gray-400 dark:hover:text-white">Peranan</a>
                        </div>
                    </li>
        ...
        <form @submit.prevent="OnSubmit" class="max-w-sm mx-auto">
            ...
            <button type="submit" class="text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-blue-700 dark:focus:ring-purple-800">Kemaskini Peranan</button>
          </form>

...
const form = useForm({
    kod:props.codes.kod,
    kategori:props.codes.kategori,
    keterangan:props.codes.keterangan,
    is_aktif:props.codes.is_aktif,
    kod_lain:props.codes.kod_lain,

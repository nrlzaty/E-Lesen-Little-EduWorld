...
const OnDelete = (row) => {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            router.delete(route('setting.user.destroy', { id: row })).then(() => {
                Swal.fire({
                    title: "Dipadamkan!",
...
watch(search, (newSearch) => {
    router.get(route('setting.user.index'), { search: newSearch }, { preserveState: true });
});
const clearSearch = () => {
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
                            ...
                            <th scope="col" class="px-4 py-4">Nama Pengguna</th>
                            <th scope="col" class="px-4 py-3">Email</th>
                            <th scope="col" class="px-4 py-3">Peranan</th>
                    ...
                    <tbody>
                        <tr v-for="(user, index) in props.Users.data" :key="index" class="border-b dark:border-gray-700">
                            <td class="px-4 py-3">{{ (props.Users.current_page - 1) * props.Users.per_page + index + 1 }}</td>
                            ...
                            <td class="px-4 py-3 flex items-center justify-end">
                                ...
                                <div class="inline-flex rounded-md shadow-sm" role="group">
                                    ...
                                    <a :href="route('setting.user.edit', user.id)">
